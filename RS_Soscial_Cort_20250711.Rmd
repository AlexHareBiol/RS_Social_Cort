...
Squirrel_Cort<-read.csv("path/Social_Cort_Data.csv")
Grids_Density<-read.csv("path/grids_density_select.csv")
```
...
# 1. Open jpeg file
jpeg("/path/density_residual_plot_11July2025.jpg", width = 700, height = 500)
# 2. Create the plot
...
jpeg("/path/neighbour_residual_plot_11July2025.jpg", width = 600, height = 500)
# 2. Create the plot
par(cex.lab = 1.8, cex.axis = 1.5, mar=c(5,6,4,1)+.1)
visreg(neighbourhood.model,
       "Nbr_ng_g_ln",
...
#Figure Save
ggsave(
  "/path/Repro_Violin_08SEP2024.jpg",
  repro.violin,
  width = 34,
  height = 19,
  units = "cm"
